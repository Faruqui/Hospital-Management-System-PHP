...
<body style="background-image: url(img/payment.jpeg);background-size: cover;background-repeat: no-repeat;">
    ...
    <div class="container p-5 my-5 bg-white border opacity-75">
        <?php if (isset($_SESSION["user_type"]) && $_SESSION["user_type"] == "Admin"): ?>
            <a href="input_payment.php" class="btn btn-primary">Register Payment</a>
        <?php endif; ?>
        <h2 class="text-center mb-4">All Pamyment's List</h2>
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while($row = mysqli_fetch_assoc($result)) {
                            ...
                            if (isset($_SESSION["user_type"]) && $_SESSION["user_type"] == "Admin") {
                                echo "<a href='edit_payment.php?id=".$row["Payment_ID"]."' class='btn btn-primary btn-sm'>Edit</a>";
                            }
                            echo "</td>
                            </tr>";
                        }
